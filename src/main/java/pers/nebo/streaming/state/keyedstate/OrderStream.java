package pers.nebo.streaming.state.keyedstate;
...
import static pers.nebo.streaming.state.keyedstate.OrderInfo1.string2OrderInfo1;
import static pers.nebo.streaming.state.keyedstate.OrderInfo2.string2OrderInfo2;
